    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/delivery-settings/**").permitAll()
                    ...
                    .requestMatchers("/api/locations/**").hasRole("CUSTOMER")
                    ...
                    .requestMatchers("/api/admin/deals/**").hasRole("ADMIN")
                    .requestMatchers("/api/admin/categories/**").hasRole("ADMIN")
                    .requestMatchers("/api/admin/delivery-settings/**").hasRole("ADMIN")
